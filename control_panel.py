...
class ControlPanel:
    ...
    def __init__(self, root):
        ...
        self.lidar_port_var = tk.StringVar(value="COM6")
    ...
    def create_sensor_tab(self):
        ...
        dashboard_btn = ttk.Button(tab, text="Open Dashboard", command=self.open_dashboard)
        ...
        lidar_port = ttk.Combobox(port_frame, textvariable=self.lidar_port_var, width=10)
        ...
        camera_port = ttk.Combobox(port_frame, textvariable=self.camera_port_var, width=10)
        camera_port['values'] = (0, 1, 2, 3)
    ...
    def open_dashboard(self):
        dashboard = Dashboard()
        dashboard.lidar_port_var = self.lidar_port_var
        dashboard.camera_port_var = self.camera_port_var
        self.update_status("Dashboard opened")
